...
<head>
<style>
#tab1{border-radius: 10px; background-color:white;font-family: tahoma; font-size: 16px; color: 
	red;}
#tab2{border-radius: 10px; background-color:white;font-family: tahoma; font-size: 17.5px; color: red;}

 #hd{border-radius: 10px; background-color: khaki;  font-family: tahoma; color: blue;}
#bt1{border-radius: 10px;background-color:green;color:white; font-size:14pt;}
...
<body style="background:white;">
	<center>
	<h1><b>Login here</h1>
	<form name="form" method="post" action="Login3.php">
		<br>

		<br>

         
	<table id="tab1" border="0" cellpadding="5" cellspacing="5" style="background:slateblue; color: white;">
		<tr><td>User Name:</td>

	<td> <input class="form-control" placeholder="username" name="email" type="text" id="tab" autofocus> </td></tr></table>
<br>
	<tr>
		<table id="tab2" border="0" cellpadding="5" cellspacing="5" style="background:slateblue; color: white;"><td> Password:</td>
	<td> <input class="form-control" placeholder="Password" name="pass" type="Password" value="" id="tab"></td></tr></table>
	<br>
	<tr><td colspan="3" align="right"><input type="submit" value="login" name="login" id="bt1"></td></tr>
...
if(isset($_POST['login']))
{
	...
	$check_user="select * from reguser WHERE username='$user_email' AND password='$user_pass'";

	$run=mysqli_query($con,$check_user);
	if(mysqli_num_rows($run))

	echo"<script>window.open('welcome3.php','_self')</script>";
...
<br>
<center>
<a href="http://localhost/web/register1.php"><font size="3"  font color="black" ><b><u>Regsiter Here</a></b></font><br>
            ...
            <div class="row mt-2">
                ...
                <div class="col-lg-3 col-md-6 mb-4 mb-md-0  pe-3 ps-3">
                   <tr><td> <h5 class="text-uppercase text-center"><b>Quick Links</h5></td>
                    ...
                    <ul class="list-unstyled">
                          ...
                          <tr><td>  <i class="fa-solid fa-angle-right text-warning"></i>
                            <br><a href="../Pages/Admission.aspx" class="text-white  text-left" style="text-decoration: none">&nbsp; <span class="glyphicon glyphicon-menu-right"> Academics</a></span>
                        </td>
                           ...
                           <tr><td> <i class="fa-solid fa-angle-right text-warning"></i>
                            <br>  <a href="http://127.0.0.1:5500/concant.html" class="text-white  text-left" style="text-decoration: none">&nbsp; <span class="glyphicon glyphicon-menu-right">  Contact Us</a></span>
                        </td>
                ...
                <table border="0" align="center">
                 <div class="col-lg-6 col-md-12 mb-md-0 pe-3 ps-3">
                     <tr><td><iframe  class="Googlemap" src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15234.976902804401!2d76.8233766!3d17.3278857!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xfba38b632d8471bd!2sSharnbasveshwar%20College%20of%20Science%2C%20Gulbarga!5e0!3m2!1sen!2sin!4v1672378438976!5m2!1sen!2sin" width="700px" height="300" style="border: 0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                         </td></tr>    
                  </div>
