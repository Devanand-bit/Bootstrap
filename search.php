...
#bt{border-radius: 10px;background-color: blue;color: white; font-size:14pt;}
#tab{border-radius: 10px; background-color:slateblue; color: white; font-size: 14pt;}
body{border-radius: 10px; background-color:white;}
</style></head></html>
<center>
<h1 id=""><b> Search Record</h1>
 
<table id="tab">
<form name="f1" action="search.php" method="POST">
<tr><td>Enter Roll Number : </td>
...
<br>
<tr><td><a href="http://localhost/web/welcome3.php"><font size="5"><b> Go to home page</a></td></tr><br>
	<br>
