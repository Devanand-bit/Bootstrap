...
#bt{border-radius: 10px;background-color: lightskyblue;color: black; font-size:14pt;}
...
$sql=mysqli_query($con,"DELETE FROM std_info where rollon='$rn'");
...
?>
 ...
 <td><tr><a href="http://localhost/web/welcome3.php"><font size="5"><b>Go to Home Page</b></font></a><br>
