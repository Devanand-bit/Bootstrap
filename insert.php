...
#bt1{border-radius: 10px;background-color:green;color:black; font-size:14pt;}
#bt2{border-radius: 10px;background-color:red;color:black; font-size:14pt;}
#tab1{border-radius: 10px; background-color:slateblue; color: white; font-size: 14pt;}
#tab2{border-radius: 10px; background-color:slateblue; color: white; font-size: 13.8pt;}
#tab3{border-radius: 10px; background-color:slateblue; color: white; font-size: 16pt;}
body{border-radius: 10px; background-color: white ;}
#hd{border-radius: 10px;background-color:; font-family: Constantia; color: black;}
</style>
	<center>
		<table id="tab1" border="0" cellpadding="15" cellspacing="15">
	<h1 id="hd"><b> Insert Student Records</b></h1>
	<br>
	<form name="f1" action="insert.php" method="POST">
		<tr>
			<td> Rool Number : </td><td><input type="text" name="t1" id="tx"><br></td>
		</tr></table><br>

		<tr>
		<table id="tab2" border="0" cellpadding="15" cellspacing="15">
	    <td> Student Name :</td><td><input type="text" name="t2" id="tx"><br></td>
		</tr></table><br>

		<tr>
         <table id="tab3" border="0" cellpadding="15" cellspacing="15">
		<td> Class Name :</td><td><input type="text" name="t3" id="tx"><br></td>
	</tr></table><br>

		<tr><td><input type="submit" name="b1" value="insert" id="bt1"></td>
...

{
    ...
    mysqli_query($con,"INSERT INTO std_info (rollon,sname,class) values ('$rl','$sn','$cl')");

    echo "<h1 style='color:green'><b> one record added in student table! thank you</h1></br>";
    mysqli_close($con);	
...
<tr><td><a href="http://localhost/web/welcome3.php"><font size="5"> <b>Go to home page
</b></a></td></tr></center><br>
