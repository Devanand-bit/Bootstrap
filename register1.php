...
#tab1{border-radius: 10px; background-color:slateblue; color: white; font-size: 18.5px;}
#tab2{border-radius: 10px; background-color:slateblue; color: white; font-size: 15px;}
#tab3{border-radius: 10px; background-color:slateblue; color: white; font-size: 14px;}

</style>
	<center>
		<h1 style='background-color: lightsteelblue;'><b>Register here</h1>
		<hr>
		<form action="" method="POST">
			<table border=0 cellpadding=5 cellspacing=5 id="tab2">
				<tr>
			<td>Enter username : </td>
			<td><input type="text" id="username" name="username" placeholder="username" required/></td></tr></table><br>

			<tr>
				<table border=0 cellpadding=5 cellspacing=5 id="tab2">
				<td>Enter Password :</td>
			<td><input id="password" name="password" type="password" placeholder="password" required/> </td></tr></table><br>

			<tr>
			<table border=0 cellpadding=5 cellspacing=5 id="tab3">   
			<td>Confirm Password :</td>

		<td><input id="confirmpassword" name="confirmpassword" type="password" placeholder="password" required/></td></tr>	</table><br>

		<tr><td><input type="submit" name="submit" value="Register" style="border-radius:10px 10px 10px 10px; background: skyblue; color:black;"><br>  Already have an usser account? 
			<a href="http://localhost/web/login3.php"><u><font color="blue">Click here</font></u> </a></td></tr><br>
		</table>
	...
	if(isset($_POST['username'])&& isset($_POST['password'])){
		...
		$slquery="SELECT 1 FROM reguser WHERE username='$username'";
	...
	$query = "INSERT INTO reguser (Username,Password) VALUES ('$username','$password')";
